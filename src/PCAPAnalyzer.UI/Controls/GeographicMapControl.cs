...
namespace PCAPAnalyzer.UI.Controls
{
    ...
    /// </summary>
    public class GeographicMapControl : UnifiedMapControl
    {
        #region Fields
        ...
        public static readonly new StyledProperty<Dictionary<string, CountryTrafficStatistics>?> CountryDataProperty =
            AvaloniaProperty.Register<GeographicMapControl, Dictionary<string, CountryTrafficStatistics>?>(
                "CountryData");

        public static readonly StyledProperty<Dictionary<Protocol, List<PacketInfo>>?> ProtocolDataProperty =
            AvaloniaProperty.Register<GeographicMapControl, Dictionary<Protocol, List<PacketInfo>>?>(
                nameof(ProtocolData));

        public static readonly StyledProperty<bool> ShowHeatMapProperty =
            AvaloniaProperty.Register<GeographicMapControl, bool>(nameof(ShowHeatMap), true);

        public static readonly StyledProperty<bool> ShowProtocolColorCodingProperty =
            AvaloniaProperty.Register<GeographicMapControl, bool>(nameof(ShowProtocolColorCoding), true);
        ...
        static GeographicMapControl()
        {
            ProtocolDataProperty.Changed.AddClassHandler<GeographicMapControl>(OnProtocolDataChanged);
        }

        public GeographicMapControl()
        {
            InitializeGeoData();
        ...
        private static void OnProtocolDataChanged(GeographicMapControl control, AvaloniaPropertyChangedEventArgs e)
        {
