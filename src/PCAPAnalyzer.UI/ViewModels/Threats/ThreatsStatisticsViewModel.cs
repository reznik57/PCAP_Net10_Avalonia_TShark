...
public partial class ThreatsStatisticsViewModel : ObservableObject
{
    ...
    public void StoreUnfilteredTotals(long packetCount)
    {
        ...
        DebugLogger.Log($"[ThreatsStatisticsViewModel] Stored unfiltered totals: {UnfilteredTotalPackets:N0} packets");
    }
    ...
    public void SetFilteredState(long filteredPacketCount, bool isFiltered)
    {
        ...
        DebugLogger.Log($"[ThreatsStatisticsViewModel] SetFilteredState: {filteredPacketCount:N0} packets (isFiltered={isFiltered}, {FilteredPacketsPercentage:F1}%)");
    }
    ...
    public void ClearFilteredState()
    {
        ...
        IsFilterActive = false;
        OnPropertyChanged(nameof(FilteredPacketsPercentage));
        DebugLogger.Log("[ThreatsStatisticsViewModel] Cleared filtered state");
    }
}
