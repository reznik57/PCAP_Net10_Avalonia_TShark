...
/// </summary>
public partial class EnhancedFilterViewModel : ObservableObject
{
    ...
    public EnhancedFilterViewModel(ITabFilterService filterService, Action<PacketFilter> onFilterApplied)
    {
