...
{
    public partial class EnhancedMapView : UserControl
    {
        private ContinentMapControlV2? _mapControl;

        public EnhancedMapView()
        {
            InitializeComponent();
        ...
        private void InitializeComponent()
        {
            ...
            _mapControl = this.FindControl<ContinentMapControlV2>("MapControl");
        }
        
        private void OnDataContextChanged(object? sender, EventArgs e)
        {
            if (DataContext is EnhancedMapViewModel viewModel)
            {
